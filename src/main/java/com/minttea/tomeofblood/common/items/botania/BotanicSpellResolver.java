...
public class BotanicSpellResolver extends SpellResolver {
    public BotanicSpellResolver(AbstractCastMethod cast, List<AbstractSpellPart> spell_recipe, SpellContext context) {
        super(cast, spell_recipe, context);
    }
    public BotanicSpellResolver(SpellContext spellContext){
        this(spellContext.getSpell().recipe, spellContext);
    }
    public BotanicSpellResolver(List<AbstractSpellPart> currentRecipe, SpellContext context) {
